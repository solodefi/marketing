var resizeImg_Portfolio = function(img) {
...
var portfolio_container_update = function() {
  ...
  var imgwidth = 1; 
  var imgheight = 1;
  var imgportfolio = document.getElementById('img-portfolio-source');

  if (imgportfolio !== null)
    imgportfolio.onload = function() {
      imgwidth = this.width;
      ...
      canvasHeight = canvasWidth / imgwidth * imgheight;
    	...
    	if (document.getElementById("portfolioCanvas") !== null ) {
    		document.getElementById("portfolioCanvas").width = canvasWidth;
    	}

    	if (document.getElementById("portfolioCanvas") !== null ) {
    		document.getElementById("portfolioCanvas").height = canvasHeight;
    	}
      ...
      if(canvasWidth > canvasHeight)
    	...
    	var cropzoom = $('#portfolio-crop-container').cropzoom({ 
    	  width:canvasWidth,
    	  height:canvasHeight,
    	  bgColor: '#CCC',
    	  enableRotation:true,
    	  ...
    	  image:{
    	    source:$('#img-portfolio-source').attr('src'),
    	    width:$('#img-portfolio-source').width,
    	    height:$('#img-portfolio-source').height,
    	    minZoom: 50 ,
...
var portfoliocropbuttonclick = function() {
  ...
  var crop_container = document.getElementById("portfolio-crop-container");
  var c = document.getElementById("myCanvas");
  var ctx = c.getContext("2d");
  var img = document.getElementById("img-portfolio-source");
...
//   	aspectRatio = heightRatio;
  ...
  var croppedImage = document.getElementById("portfolio-croppedimage");
